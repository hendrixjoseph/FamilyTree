...
public class PersonsBean extends DataBean<PersonView>
{
    ...
    {
        "ID", "FATHER_NAME", "MOTHER_NAME", "NAME", "GENDER", "PLACE_OF_BIRTH", "DATE_OF_BIRTH", "PLACE_OF_DEATH", "DATE_OF_DEATH"
    };
    private static final String[] prettyNames =
    {
        "Id", "Father Name", "Mother Name", "Name", "Gender", "Place of Birth", "Date of Birth", "Place of Death", "Date of Death"
    };
    private static final String[] linkColumns =
    {
        "Father Name", "Mother Name", "Name"
    };
