...
public class BirthsAndDeathsDataBean
{
    ...
    /**
     * Returns a map of decades (as a String) to an array integer of births and deaths in that decade. Internally, this
     * is a {@link LinkedHashMap}. The number of births is in the zeroth element, and the number of deaths is in the
     * next element.
     * <p>
     * The method gets its values from {@code PER_DECADE_COMBINED_VIEW}, which is just a sum of the union of {@code
     * PER_DECADE_CLEAN_VIEW} and {@code PER_DECADE_VIEW}.
     * <p>
    ...
    /**
     * Returns a map of decades (as a String) to an integer array of births and deaths in that decade. Internally, this
     * is a {@link LinkedHashMap}. The number of births is in the zeroth element, and the number of deaths is in the
     * next element.
     * <p>
     * The method gets its values from {@code PER_DECADE_CLEAN_VIEW}, which estimates the birth year and death year
    ...
    /**
     * Returns a map of months (as a String) to an integer array of births and deaths in that month. Internally, this is
     * a {@link LinkedHashMap}. The number of births is in the zeroth element, and the number of deaths is in the next
     * element.
     * <p>
