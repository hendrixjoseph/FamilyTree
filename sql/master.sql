...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "JOE"."PLACE_SEQUENCE"  MINVALUE 1 MAXVALUE 99999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQUENCE_PERSON
--------------------------------------------------------

   CREATE SEQUENCE  "JOE"."SEQUENCE_PERSON"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Table BIRTH
--------------------------------------------------------
...
REM INSERTING into JOE.BIRTH
SET DEFINE OFF;
Insert into JOE.BIRTH (PERSON_ID,PLACE_ID,"DATE") values (1,1,to_date('04-MAR-1827','DD-MON-YYYY'));
Insert into JOE.BIRTH (PERSON_ID,PLACE_ID,"DATE") values (2,2,to_date('23-MAY-1795','DD-MON-YYYY'));
REM INSERTING into JOE.DEATH
SET DEFINE OFF;
Insert into JOE.DEATH (PERSON_ID,PLACE_ID,"DATE") values (1,3,to_date('29-JAN-1900','DD-MON-YYYY'));
Insert into JOE.DEATH (PERSON_ID,PLACE_ID,"DATE") values (2,1,to_date('12-DEC-1881','DD-MON-YYYY'));
REM INSERTING into JOE.FATHER_OF
SET DEFINE OFF;
Insert into JOE.FATHER_OF (FATHER_ID,CHILD_ID) values (2,1);
REM INSERTING into JOE.GENDER
SET DEFINE OFF;
Insert into JOE.GENDER (ABBR,FULL_WORD) values ('M','Male');
Insert into JOE.GENDER (ABBR,FULL_WORD) values ('F','Female');
Insert into JOE.GENDER (ABBR,FULL_WORD) values ('O','Other');
Insert into JOE.GENDER (ABBR,FULL_WORD) values ('U','Unknown');
...
REM INSERTING into JOE.PLACE
SET DEFINE OFF;
Insert into JOE.PLACE (ID,NAME) values (1,'Ohio');
Insert into JOE.PLACE (ID,NAME) values (2,'Washington, Pennsylvania');
Insert into JOE.PLACE (ID,NAME) values (3,'Jacksonville, Ohio');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE TRIGGER "JOE"."PLACE_SEQ_TRIGGER" 
...
END;
/
ALTER TRIGGER "JOE"."PLACE_SEQ_TRIGGER" ENABLE;
